...
<Level id="dotnet-under-the-hood" number="2" name=".NET під капотом" difficulty={<span style={{ color: "orangered", fontWeight: "bold" }}>Hard as hell 🔥</span>} objectives="Понять SDK." labels={{ level: "Раздел", backToTop: "Наверх", difficulty: "Сложность:", objectives: "Мета:" }} />
<ul>
  <li class="details">
...
<Level id="csharp-essential-topics" number="3" name="Самые вежные темы C#" difficulty="Ну так себе." objectives="Понять SDK." labels={{ level: "Раздел", backToTop: "наверх", difficulty: "Сложность:", objectives: "Мета:" }} />
<ul>
  <li class="details">
...
<Level id="clean-code-principles" number="4" name="Принципы чистого кода" difficulty="Семь раз отмерь, один раз отрежь." objectives="Понять, как писать такой код, который захочется читать." labels={{ level: "Раздел", backToTop: "Наверх", difficulty: "Сложность:", objectives: "Мета:" }} />
<ul>
  <li class="details">
...
<Level id="bonus" number="" name="Корисні ресурси" difficulty="" objectives="" labels={{ level: "Бонус", backToTop: "Наверх", difficulty: "", objectives: "" }} />
<div class="columns">
